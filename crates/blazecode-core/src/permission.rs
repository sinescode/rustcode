...
//!
//! Ported from:
//! - `packages/blazecode/src/permission/index.ts`
//! - `packages/blazecode/src/permission/arity.ts`
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/index.ts` lines 39–49.
#[derive(Debug, Clone)]
...
///
/// Implements the exact semantics of BlazeCode's `Wildcard.match()`:
...
///
/// ```
/// use blazecode_core::permission::{evaluate, PermissionRule, PermissionAction, PermissionRuleset};
///
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/arity.ts` lines 24–161.
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/arity.ts` lines 1–9.
///
/// # Examples
///
/// ```
/// use blazecode_core::permission::bash_arity_prefix;
///
/// // Simple command
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/index.ts` lines 197–209.
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/index.ts` lines 189–195.
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/index.ts` lines 211–213.
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/index.ts` lines 215–224.
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/index.ts` lines 29–32.
struct PendingEntry {
...
///
/// # Source
/// Ported from `packages/blazecode/src/permission/index.ts` lines 53–185
...
impl PermissionService {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/permission/index.ts` lines 78–118.
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/permission/index.ts` lines 120–178
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/permission/index.ts` lines 180–183.
