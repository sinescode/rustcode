...
//!
//! Ported from: `packages/blazecode/src/ide/index.ts`
...
///
/// # Source
/// `packages/blazecode/src/ide/index.ts` lines 6–12.
...
///
/// # Source
/// `packages/blazecode/src/ide/index.ts` lines 29–37.
...
///
/// # Source
/// `packages/blazecode/src/ide/index.ts` lines 39–41.
pub fn already_installed(blazecode_caller: Option<&str>) -> bool {
    matches!(blazecode_caller, Some("vscode") | Some("vscode-insiders"))
}

// ── Extension name ────────────────────────────────────────────────────

/// The extension identifier installed by blazecode/blazecode.
pub const EXTENSION_ID: &str = "sst-dev.blazecode";
