...
//! - `packages/blazecode/src/session/compaction.ts` (lines 1–621)
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` line 38 `PRUNE_MINIMUM`.
pub const PRUNE_MINIMUM_TOKENS: u64 = 20_000;

/// Tokens to protect from pruning.
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` line 39 `PRUNE_PROTECT`.
pub const PRUNE_PROTECT_TOKENS: u64 = 40_000;

/// Default number of recent turns to keep.
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` line 43 `DEFAULT_TAIL_TURNS`.
pub const DEFAULT_TAIL_TURNS: u64 = 2;

/// Minimum tokens to preserve in recent context.
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` line 44 `MIN_PRESERVE_RECENT_TOKENS`.
pub const MIN_PRESERVE_RECENT_TOKENS: u64 = 2_000;

/// Maximum tokens to preserve in recent context.
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` line 45 `MAX_PRESERVE_RECENT_TOKENS`.
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` lines 146–151 `process` input.
#[derive(Debug, Clone)]
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` lines 153–159 `create` input.
#[derive(Debug, Clone)]
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` line 152 `process` return.
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` lines 46–49 `Turn`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` lines 51–54 `Tail`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` lines 56–60 `CompletedCompaction`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` lines 29–36 `Event.Compacted`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl SessionCompaction {
    ...
    ///
    /// Ported from: `packages/blazecode/src/session/compaction.ts` — `select`
    pub fn select(
        &self,
    ...
    ///
    /// Ported from: `packages/blazecode/src/session/compaction.ts` lines 46-54
...
///
/// Ported from: `packages/blazecode/src/session/compaction.ts` lines 46–49 `Turn`.
#[derive(Debug, Clone)]
struct Turn {
    start: usize,
    end: usize,
...
///
/// Ported from: `packages/blazecode/src/session/compaction.ts` lines 97–113 `turns`.
...
impl CompactionSelector {
    ...
    ///
    /// Ported from: `packages/blazecode/src/session/compaction.ts` —
...
impl SessionCompaction {
    ...
    /// - `packages/blazecode/src/session/compaction.ts` — `process`
