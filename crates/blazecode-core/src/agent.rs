...
//!
//! Ported from:
//! - `packages/blazecode/src/agent/agent.ts` (459 lines)
//! - `packages/blazecode/src/agent/subagent-permissions.ts` (27 lines)
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/prompt/explore.txt`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/prompt/compaction.txt`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/prompt/summary.txt`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/prompt/title.txt`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/generate.txt`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/agent.ts` lines 35–56 (`Info` Schema.Struct).
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/agent.ts` lines 58–62 (`GeneratedAgent` Schema.Struct).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/subagent-permissions.ts` lines 14–27.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/agent.ts` lines 84–437 (Service + layer).
#[derive(Debug)]
...
impl AgentService {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/agent/agent.ts` lines 88–308
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/agent/agent.ts` line 310–312 (`get`).
    #[must_use]
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/agent/agent.ts` lines 314–323 (`list`).
    #[must_use]
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/agent/agent.ts` lines 326–338 (`defaultInfo`).
    #[must_use]
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/agent/agent.ts` lines 340–342 (`defaultAgent`).
    #[must_use]
    ...
    /// in `.blazecode/agents/{identifier}.md` within the data directory.
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/agent/agent.ts` lines 366–435 (`generate`).
    pub async fn generate(
        ...
        let agents_dir = self.data_dir.join(".blazecode").join("agents");
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/agent.ts` lines 117–134.
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/agent.ts` lines 138–263.
fn build_builtin_agents(
    ...
    let dot_blazecode_plans = ".blazecode/plans/*.md".to_string();
    ...
    plan_edit.insert(dot_blazecode_plans.clone(), config::PermissionAction::Allow);
...
///
/// # Source
/// Ported from `packages/blazecode/src/agent/agent.ts` lines 279–291.
