...
//! `packages/core/src/util/` and `packages/blazecode/src/util/`.
//!
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/html.ts` `escapeHtml()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/archive.ts` `extractZip()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/bom.ts` `split()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/bom.ts` `join()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/bom.ts` `readFile()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/bom.ts` `syncFile()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/data-url.ts` `decodeDataUrl()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/defer.ts` `defer()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/timeout.ts` `withTimeout()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/util/repository.ts` `parseRepositoryReference()`.
...
mod tests {
    ...
    #[test]
    fn test_glob_scan() {
        let dir = std::env::temp_dir().join("blazecode-util-glob-test");
    ...
    #[test]
    fn test_bom_read() {
        let dir = std::env::temp_dir().join("blazecode-util-bom-test");
        let _ = std::fs::remove_dir_all(&dir);
        std::fs::create_dir_all(&dir).unwrap();
