...
//!
//! Ported from: `packages/blazecode/src/bus/global.ts`
...
///
/// # Source
/// Ported from `packages/blazecode/src/bus/global.ts` lines 4–9.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/tui-event.ts` and
/// `packages/blazecode/src/server/routes/instance/httpapi/groups/tui.ts`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "type")]
...
///
/// # Source
/// Ported from `packages/blazecode/src/bus/global.ts` lines 11–20.
pub struct EventBus {
...
impl EventBus {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/bus/global.ts` lines 14–19.
    ///
    /// # Errors
...
///
/// # Source
/// Ported from `packages/blazecode/src/bus/global.ts` line 22:
...
///
/// # Source
/// Ported from `packages/blazecode/src/bus/global.ts` lines 15–16:
/// ```ts
