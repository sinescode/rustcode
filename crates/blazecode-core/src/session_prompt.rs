...
//! - `packages/blazecode/src/session/prompt.ts` (lines 1594–1723)
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` lines 1594–1616 `PromptInput`.
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` lines 1607–1614 `parts`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "type")]
pub enum PromptPart {
    /// Plain text
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` — `TextPartInput`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` — `FilePartInput`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` lines 1651 — `FilePartSource`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` — `AgentPartInput`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` — `SubtaskPartInput`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` line 1605 `format`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "type")]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` lines 1622–1628 `ShellInput`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` lines 1631–1656 `CommandInput`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/prompt.ts` lines 1618–1620 `LoopInput`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// Ported from:
/// - `packages/blazecode/src/session/prompt.ts` (lines 1-1723)
...
impl SessionPromptBuilder {
    ...
    ///
    /// Ported from: `packages/blazecode/src/session/prompt.ts` — `buildPrompt`
    ...
    ///
    /// Ported from: `packages/blazecode/src/session/prompt.ts` — top-level `prompt()`
    pub fn build_prompt(
        &self,
