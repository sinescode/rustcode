...
//! Ported from:
//!
//! - `packages/blazecode/src/provider/provider.ts` (1976 lines)
//! - `packages/blazecode/src/provider/transform.ts` (1427 lines)
//! - `packages/blazecode/src/provider/auth.ts` (233 lines)
//! - `packages/blazecode/src/provider/error.ts` (188 lines)
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/model-status.ts` line 5.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 952–956.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 958–964.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 966–971.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 973–981.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 983–986.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 988–996.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CostTier {
    #[serde(default)]
    pub input: f64,
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 992–995.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TierInfo {
    #[serde(rename = "type")]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1003–1009.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 998–1010.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct Cost {
    #[serde(default)]
    pub input: f64,
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1012–1016.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 665–1043.
pub type Variants = HashMap<String, serde_json::Value>;

/// Model information.
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1018–1033.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct Model {
    /// Model ID
    pub id: ModelId,
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1038.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1035–1044.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1957–1963.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct ModelRef {
    #[serde(rename = "providerID")]
    pub provider_id: ProviderId,
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1048–1053.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1055–1059.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1112–1123.
#[async_trait]
pub trait ProviderCatalog: Send + Sync {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/provider/provider.ts` line 1815–1825.
    async fn closest(
        &self,
        provider_id: &str,
        query: &[String],
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/provider/provider.ts` line 1827–1895.
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/provider/provider.ts` line 1897–1929.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 25–27.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 65–321.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 479–496.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 498–505.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 507–515.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1947–1955.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 1948–1955.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 30–62.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 18.
pub const OUTPUT_TOKEN_MAX: u64 = 32_000;

/// Compute the maximum output tokens for a model, capped at `output_token_max`.
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 1285–1287.
#[must_use]
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/provider.ts` line 107–134.
...
///
/// # Source
/// Ported from `packages/blazecode/src/provider/transform.ts` line 517.
...
///
/// Ported from `packages/blazecode/src/provider/error.ts` `ParsedStreamError`.
...
///
/// Ported from `packages/blazecode/src/provider/error.ts` `parseStreamError`.
...
///
/// Ported from `packages/blazecode/src/provider/error.ts` `ParsedAPICallError`.
#[derive(Debug, Clone)]
...
///
/// Ported from `packages/blazecode/src/provider/error.ts` `parseAPICallError`.
...
///
/// Ported from `packages/blazecode/src/provider/transform.ts` `applyCaching`.
#[derive(Debug, Clone)]
...
///
/// Ported from `packages/blazecode/src/provider/transform.ts` `unsupportedParts`.
...
///
/// Ported from `packages/blazecode/src/provider/transform.ts` `variants`.
...
///
/// Ported from `packages/blazecode/src/provider/transform.ts` `options`.
...
///
/// Ported from `packages/blazecode/src/provider/transform.ts` `providerOptions`.
...
///
/// Ported from `packages/blazecode/src/provider/transform.ts` `sanitizeOpenAISchema`.
...
///
/// Ported from `packages/blazecode/src/provider/transform.ts` `schema`.
