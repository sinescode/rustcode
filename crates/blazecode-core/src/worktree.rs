...
//!
//! Ported from:
//! - `packages/blazecode/src/worktree/index.ts` (lines 1–655)
...
///
/// # Source
/// `packages/blazecode/src/worktree/index.ts` line 508 (`project?.commands?.start`).
...
///
/// # Source
/// `packages/blazecode/src/worktree/index.ts` lines 501–508 (`runStartScripts`).
...
///
/// # Source
/// `packages/blazecode/src/worktree/index.ts` line 244
...
///
/// # Source
/// `packages/blazecode/src/worktree/index.ts` lines 39–44 (`Info` schema).
...
///
/// # Source
/// `packages/blazecode/src/worktree/index.ts` lines 46–52 (`CreateInput` schema).
...
///
/// # Source
/// `packages/blazecode/src/worktree/index.ts` lines 135–142 (`Interface`).
#[derive(Debug, Clone)]
...
impl WorktreeManager {
    ...
    /// stored under `.blazecode/worktrees/`. Here we place them under
    /// `<repo>/.blazecode/worktrees/`.
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` line 224.
    fn worktree_root(&self) -> PathBuf {
        self.repo.directory.join(".blazecode").join("worktrees")
    }

    /// Resolve a directory to its canonical (real) path.
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 311–316 (`canonical`).
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 107–114 (`slugify`).
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 191–213 (`candidate`).
    fn candidate(
        &self,
        name: Option<&str>,
        detached: bool,
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 318–335 (`parseWorktreeList`).
    ...
    /// inside the repo's `.blazecode/worktrees/` directory.
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 215–228 (`makeWorktreeInfo`).
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 305–309 (`create`).
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 230–245 (`setup`)
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 349–375 (`list`).
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 404–465 (`remove`).
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/worktree/index.ts` lines 541–627 (`reset`).
