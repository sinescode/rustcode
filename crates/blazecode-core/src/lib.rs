...
//! Core library for blazecode — AI-powered development tool.
//!
//! Ported from the BlazeCode TypeScript monorepo.
//! Source: `packages/blazecode/src/` and `packages/core/src/`
