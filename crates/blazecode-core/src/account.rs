...
///
/// Ported from: `packages/blazecode/src/account/account.ts` —
...
impl AccountService {
    ...
    pub async fn login(&self) -> Result<AccountLogin, AccountError> {
        ...
        let response = self
            .http_client
            .post(&url)
            .json(&serde_json::json!({ "client_id": "blazecode-cli" }))
            .send()
            .await
            .map_err(|e| {
                AccountError::TransportError(AccountTransportError {
    ...
    ///
    /// Ported from: `packages/blazecode/src/account/account.ts` — `fetchUser`.
    ...
    ///
    /// Ported from: `packages/blazecode/src/account/account.ts` — `fetchOrgs`.
    ...
    ///
    /// Ported from: `packages/blazecode/src/account/account.ts` lines 329–340.
    ...
    ///
    /// Ported from: `packages/blazecode/src/account/account.ts` lines 351–373.
    pub async fn config(
        &self,
