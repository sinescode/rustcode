...
impl SessionHistory {
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/message-v2.ts` lines 532–583 `filterCompacted`.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/message-v2.ts` lines 142–434 `toModelMessagesEffect`.
