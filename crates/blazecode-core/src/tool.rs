...
//!
//! Ported from:
//! - `packages/blazecode/src/tool/tool.ts` (183 lines)
//! - `packages/blazecode/src/tool/registry.ts` (441 lines)
//! - `packages/blazecode/src/tool/schema.ts` (15 lines)
//!
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/tool.ts` line 36–46.
#[derive(Clone)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/tool.ts` line 48–53.
...
/// running session.
///
/// Ported from `packages/blazecode/src/tool/task.ts` lines 18–22 (`TaskPromptOps` interface).
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/tool.ts` line 55–65.
#[async_trait]
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/tool.ts` `Def` type.
#[derive(Clone)]
pub struct ToolDef {
    /// Tool ID
    pub id: String,
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/tool.ts` `Info` type.
pub struct ToolInfo {
    /// Tool ID
    pub id: String,
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/registry.ts` `ToolDefinition.execute`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/registry.ts` `ToolDefinition` from plugin.
#[derive(Clone)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/registry.ts`.
...
impl ToolRegistry {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/tool/registry.ts` `execute` method.
...
// ═══════════════════════════════════════════════════════════════════
// Tool prompt templates — ported from packages/blazecode/src/tool/*.txt
// ═══════════════════════════════════════════════════════════════════
...
For workspaceSymbol, filePath is not sent in the LSP workspace/symbol request. It is used by blazecode to select and start the matching LSP server.
...
// ═══════════════════════════════════════════════════════════════════
// JSON Schema helpers — ported from packages/blazecode/src/tool/json-schema.ts
// ═══════════════════════════════════════════════════════════════════
...
///
/// Ported from `packages/blazecode/src/tool/json-schema.ts` lines 28–88.
...
///
/// Ported from `packages/blazecode/src/tool/json-schema.ts` lines 121–144.
...
///
/// Ported from `packages/blazecode/src/tool/json-schema.ts` lines 146–150.
...
///
/// # Source
/// Ported from `packages/blazecode/src/tool/tool.ts` streaming pattern.
#[derive(Debug, Clone)]
...
///
/// # Source
/// Ported from the streaming tool pattern in BlazeCode.
#[async_trait]
