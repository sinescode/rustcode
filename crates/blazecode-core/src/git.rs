...
//!
//! Ported from:
//! - `packages/blazecode/src/git/index.ts` (lines 1–350)
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` line 31.
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 38–42.
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 44–48.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Stat {
    pub file: String,
    pub additions: u64,
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 50–53.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Patch {
    pub text: String,
    pub truncated: bool,
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 55–58.
#[derive(Debug, Clone)]
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 60–66.
#[derive(Debug, Clone)]
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 33–36.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Base {
    pub name: String,
    #[serde(rename = "ref")]
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 7–18.
const GIT_CFG: &[&str] = &[
    "--no-optional-locks",
    "-c",
    "core.autocrlf=false",
...
///
/// # Source
/// `packages/blazecode/src/snapshot/index.ts` line 33.
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 75–91 `Interface`.
#[derive(Debug, Clone)]
pub struct Git {
    worktree: PathBuf,
}
...
impl Git {
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 110–132.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 164–169.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 171–175.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 177–193.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 195–198.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 200–205.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 207–213.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 215–226.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 228–238.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 240–261.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 263–269.
    pub fn patch(
        &self,
        git_ref: &str,
        file: &str,
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 271–277.
    pub fn patch_all(
        &self,
        git_ref: &str,
        options: Option<&PatchOptions>,
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 279–299.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 301–320.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/git/index.ts` lines 322–324.
...
///
/// # Source
/// `packages/blazecode/src/git/index.ts` lines 93–99.
