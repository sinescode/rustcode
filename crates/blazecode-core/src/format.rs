...
//!
//! Ported from:
//! - `packages/blazecode/src/cli/cmd/stats.ts` line 386 — [`format_number`]
//! - `packages/tui/src/util/format.ts` lines 1–20 — [`format_duration`]
//! - `packages/blazecode/src/format/index.ts` — formatter registry
//! - `packages/blazecode/src/format/formatter.ts` — 25 code formatter definitions
//!
...
///
/// # Source
/// Adapted from `formatNumber` in `packages/blazecode/src/cli/cmd/stats.ts`
