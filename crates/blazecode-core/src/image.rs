...
//!
//! Ported from:
//! - `packages/blazecode/src/util/media.ts` lines 1–26 — [`sniff_attachment_mime`],
...
//! - `packages/blazecode/src/image/image.ts` lines 1–206 — image normalization service
...
///
/// # Source
/// `packages/blazecode/src/image/image.ts` line 25.
pub const MAX_BASE64_BYTES: u64 = 5 * 1024 * 1024;

/// Maximum image width in pixels.
///
/// # Source
/// `packages/blazecode/src/image/image.ts` line 27.
pub const MAX_WIDTH: u32 = 2000;

/// Maximum image height in pixels.
///
/// # Source
/// `packages/blazecode/src/image/image.ts` line 28.
...
///
/// # Source
/// Ported from `sniffAttachmentMime` in `packages/blazecode/src/util/media.ts`
...
///
/// # Source
/// Ported from `isImageAttachment` in `packages/blazecode/src/util/media.ts`
...
///
/// # Source
/// Ported from `isMedia` in `packages/blazecode/src/util/media.ts`
/// lines 7–9.
///
/// # Examples
/// ```ignore
...
///
/// # Source
/// Ported from `isPdfAttachment` in `packages/blazecode/src/util/media.ts`
/// lines 3–5.
///
/// # Examples
/// ```ignore
...
///
/// # Source
/// Ported from the size checks in `packages/blazecode/src/image/image.ts`
...
///
/// # Source
/// Ported from `packages/blazecode/src/image/image.ts` — the return value
...
///
/// Ported from the `Image` service in `packages/blazecode/src/image/image.ts`
...
impl ImageNormalizer {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/image/image.ts` lines 75–163.
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/image/image.ts` lines 75–164.
