...
//! - `packages/blazecode/src/mcp/oauth-callback.ts`
//! - `packages/blazecode/src/mcp/index.ts` (auth flow integration lines 748–898)
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/oauth-callback.ts`
/// and `packages/blazecode/src/mcp/index.ts` auth flow errors.
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/index.ts` the `generateCodeVerifier`
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/index.ts` (the PKCE challenge
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/oauth-provider.ts` `state()` method
/// (lines 154–162).
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/oauth-callback.ts` — the
...
<html>
<head>
  <title>BlazeCode - Authorization Successful</title>
  <style>
...
<html>
<head>
  <title>BlazeCode - Authorization Failed</title>
  <style>
    body {{ font-family: system-ui, -apple-system, sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; background: #1a1a2e; color: #eee; }}
    .container {{ text-align: center; padding: 2rem; }}
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/index.ts` — the token exchange
...
/// and `packages/blazecode/src/mcp/index.ts` (the capture of
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/index.ts` — `open()` (line 838)
...
///
/// # Source
/// Ported from `packages/blazecode/src/mcp/index.ts` — `startAuth()`,
...
impl McpOAuthClient {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/mcp/index.ts` — `startAuth()` (line 748).
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/mcp/index.ts` — the
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/mcp/index.ts` — `finishAuth()`
