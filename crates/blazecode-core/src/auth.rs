...
//!
//! Ported from: `packages/blazecode/src/auth/index.ts`
...
///
/// # Source
/// `packages/blazecode/src/auth/index.ts` line 8.
pub const OAUTH_DUMMY_KEY: &str = "blazecode-oauth-dummy-key";
...
///
/// # Source
/// `packages/blazecode/src/auth/index.ts` — `Oauth` class.
...
///
/// # Source
/// `packages/blazecode/src/auth/index.ts` — `Api` class.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct AuthApi {
    /// The API key value.
    pub key: String,
...
///
/// # Source
/// `packages/blazecode/src/auth/index.ts` — `WellKnown` class.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
///
/// # Source
/// `packages/blazecode/src/auth/index.ts` — `Info` (lines 35–36).
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
///
/// # Source
/// Ported from `packages/blazecode/src/auth/index.ts` lines 43–91.
#[derive(Debug, Clone)]
pub struct Auth {
...
impl Auth {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/auth/index.ts` lines 58–66 (`all`).
    fn load_store(&self) -> AuthStore {
        // Check BLAZECODE_AUTH_CONTENT env var first (TS line 59–63)
        if let Ok(content) = std::env::var("BLAZECODE_AUTH_CONTENT") {
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/auth/index.ts` lines 69–71 (`get`).
    #[must_use]
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/auth/index.ts` lines 73–81 (`set`).
    ...
    ///
    /// # Source
    /// Ported from `packages/blazecode/src/auth/index.ts` lines 83–89 (`remove`).
...
mod tests {
    ...
    fn oauth_dummy_key_constant() {
        assert_eq!(OAUTH_DUMMY_KEY, "blazecode-oauth-dummy-key");
    }
