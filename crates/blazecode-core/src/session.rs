...
//!
//! Ported from:
//! - `packages/blazecode/src/session/processor.ts` (lines 1–1084)
//! - `packages/blazecode/src/session/session.ts` (lines 1–1119)
//! - `packages/blazecode/src/session/message-v2.ts` (lines 1–744)
//! - `packages/blazecode/src/session/compaction.ts` (lines 1–620)
//! - `packages/blazecode/src/session/retry.ts` (lines 1–201)
//! - `packages/blazecode/src/session/overflow.ts` (lines 1–34)
//! - `packages/blazecode/src/session/status.ts` (lines 1–97)
//! - `packages/blazecode/src/session/run-state.ts` (lines 1–156)
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` line 455.
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` lines 213–234 `Info`.
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` lines 205–209.
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` lines 164–169.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` lines 171–181.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` lines 191–196.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` lines 198–203.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/message-v2.ts` — `WithParts` concept.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Message {
...
///
/// # Source
/// `packages/blazecode/src/session/message-v2.ts` line 91–97.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "role")]
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` — `Assistant` fields.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/message-v2.ts` line 98–104.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "type")]
pub enum Part {
    #[serde(rename = "text")]
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 759–839.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TextPart {
    pub id: PartId,
    pub message_id: MessageId,
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 295–346.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ToolPart {
    pub id: PartId,
    pub message_id: MessageId,
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 326–336.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "status")]
pub enum ToolState {
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 373–426.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/message.ts` lines 64–71 `SourceUrlPart`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 693–757.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/compaction.ts` lines 554–577.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/session.ts` lines 461–514 `Interface`.
...
impl SessionManager {
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 709–731.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` line 582.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 588–594.
    pub async fn list(
        &self,
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 776–789.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 648–669.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 733–773.
    pub async fn fork(
        &self,
        session_id: &str,
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 671–675.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` — `removeMessage()`.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` — `removePart()`.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` — `updatePart()`.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 791–793.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 795–797.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 799–801.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 803–805.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 807–814.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 816–826.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 828–830.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 832–837.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 839–841.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 843–850.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 852–855.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 638–646.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 597–636.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 687–707.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 917–933.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 906–914.
...
///
/// # Source
/// Ported from `packages/blazecode/src/session/session.ts` `fromRow()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/session/session.ts`
#[derive(Debug, Clone, Default)]
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` line 36.
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` line 35.
const DOOM_LOOP_THRESHOLD: usize = 3;

/// Internal tool call tracking.
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 66–74.
#[derive(Debug)]
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 76–86.
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` — `LLM.StreamInput`.
#[derive(Debug, Clone)]
...
///
/// # Source
/// `packages/blazecode/src/session/processor.ts` lines 90–1084.
...
impl SessionProcessor {
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/processor.ts` lines 960–1034.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/processor.ts` lines 994–1027.
    /// `packages/blazecode/src/session/retry.ts` lines 176–199.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/processor.ts` lines 969–980.
    async fn run_stream(
        &self,
        ctx: &mut ProcessorContext,
        provider: &dyn crate::provider::Provider,
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/processor.ts` lines 371–843.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/processor.ts` lines 203–227.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/processor.ts` lines 229–246.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/processor.ts` lines 846–915.
    ...
    ///
    /// # Source
    /// `packages/blazecode/src/session/session.ts` lines 384–453 `getUsage`.
...
///
/// # Source
/// `packages/blazecode/src/session/overflow.ts` line 8.
...
///
/// # Source
/// `packages/blazecode/src/session/overflow.ts` lines 10–20.
...
///
/// # Source
/// `packages/blazecode/src/session/overflow.ts` lines 22–34.
...
///
/// # Source
/// `packages/blazecode/src/session/retry.ts` lines 14–24.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/retry.ts` lines 16–23.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// `packages/blazecode/src/session/retry.ts` lines 31–33.
...
///
/// # Source
/// `packages/blazecode/src/session/retry.ts` lines 35–66.
...
///
/// # Source
/// `packages/blazecode/src/session/retry.ts` lines 68–152.
...
///
/// # Source
/// `packages/blazecode/src/session/retry.ts` lines 76–88.
...
///
/// # Source
/// `packages/blazecode/src/session/retry.ts` lines 89–121.
...
pub fn build_retryable(error_body: &str, provider: &str) -> Option<Retryable> {
    if is_free_usage_limit_error(error_body) {
        return Some(Retryable {
            ...
            action: Some(RetryableAction {
                ...
                message: "Subscribe to BlazeCode Go for reliable access to the best open-source models, starting at $5/month.".to_string(),
    ...
    if is_go_usage_limit_error(error_body) {
        ...
        if let Ok(body) = serde_json::from_str::<serde_json::Value>(error_body) {
            ...
            let link = format!("https://blazecode.ai/workspace/{}/go", workspace);
            return Some(Retryable {
...
///
/// # Source
/// `packages/blazecode/src/session/status.ts` lines 9–33.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "type")]
    ...
    fn test_session_info_with_summary() {
        let info = SessionInfo {
            ...
            share: Some(ShareInfo {
                url: "https://share.blazecode.dev/abc".into(),
            }),
