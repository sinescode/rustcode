...
//!
//! Ported from: `packages/opencode/src/server/routes/instance/httpapi/middleware/instance-context.ts`
//! and `packages/opencode/src/server/routes/instance/httpapi/lifecycle.ts`
