...
//!
//! Ported from: `packages/opencode/src/server/routes/instance/httpapi/groups/model.rs`
...
///
/// # Source
/// Ported from `packages/opencode/src/server/routes/instance/httpapi/groups/model.ts`
