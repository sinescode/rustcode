...
//! `packages/blazecode/src/server/tui-event.ts`
//!
...
///
/// # Source
/// `packages/blazecode/src/server/tui-event.ts` — `TuiEvent` definitions.
...
pub enum AppEvent {
    ...
    PermissionAsk {
        request: blazecode_core::permission::PermissionRequest,
    },
