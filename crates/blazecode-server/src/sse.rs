...
//!
//! Ported from: `packages/blazecode/src/server/routes/instance/httpapi/handlers/event.ts`
//! and `packages/blazecode/src/server/routes/instance/httpapi/groups/event.ts`
//!
