...
//!
//! Ported from: `packages/blazecode/src/server/routes/instance/httpapi/middleware/proxy.ts`
//! and `packages/blazecode/src/server/proxy-util.ts`
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/proxy-util.ts` `hop` set.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/proxy-util.ts` `sanitize()`.
fn sanitize_headers(headers: &mut HeaderMap) {
    for key in HOP_BY_HOP {
        headers.remove(*key);
    }
    headers.remove("accept-encoding");
    headers.remove("x-blazecode-directory");
    headers.remove("x-blazecode-workspace");
}

/// Merge extra headers into a header map after sanitization.
///
/// # Source
/// Ported from `packages/blazecode/src/server/proxy-util.ts` `headers()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/proxy-util.ts` `websocketProtocols()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/proxy-util.ts` `websocketTargetURL()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/routes/instance/httpapi/middleware/proxy.ts` `http()`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/routes/instance/httpapi/middleware/proxy.ts` `websocket()`.
