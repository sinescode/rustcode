...
//!
//! Ported from: `packages/blazecode/src/server/routes/instance/httpapi/groups/credential.ts`
...
async fn update_credential(
    ...
    match blazecode_core::config::Config::save_auth(&credential_id, &cred) {
        Ok(()) => {
...
async fn remove_credential(
    ...
    match blazecode_core::config::Config::remove_auth(&credential_id) {
        Ok(()) => {
