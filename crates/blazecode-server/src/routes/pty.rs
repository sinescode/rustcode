...
//!
//! Ported from: `packages/blazecode/src/server/routes/instance/httpapi/groups/pty.ts`
//!
...
///
/// # Source
/// `packages/blazecode/src/server/routes/instance/httpapi/groups/pty.ts`
...
async fn list_shells() -> impl IntoResponse {
    let config = blazecode_core::shell::ShellConfig::default();
    let service = blazecode_core::shell::ShellService::new(config);
