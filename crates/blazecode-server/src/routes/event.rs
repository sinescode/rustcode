...
//!
//! Ported from: `packages/blazecode/src/server/routes/instance/httpapi/groups/event.ts`
//! and `packages/blazecode/src/server/routes/instance/httpapi/handlers/event.ts`
//!
...
///
/// # Source
/// `packages/blazecode/src/server/routes/instance/httpapi/handlers/event.ts` lines 28–86.
...
fn bus_rx_to_receiver(
    mut sub: blazecode_core::bus::BusSubscription,
) -> tokio::sync::broadcast::Receiver<blazecode_core::bus::GlobalEvent> {
