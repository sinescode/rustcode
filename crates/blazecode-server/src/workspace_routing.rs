//! Workspace routing middleware — resolves `x-blazecode-directory` to a workspace,
//! then routes locally or signals proxy forwarding.
//!
//! Ported from: `packages/blazecode/src/server/routes/instance/httpapi/middleware/workspace-routing.ts`
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/shared/workspace-routing.ts` `isLocalWorkspaceRoute`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/shared/workspace-routing.ts` `getWorkspaceRouteSessionID`.
...
///
/// # Source
/// Ported from `packages/blazecode/src/server/shared/workspace-routing.ts` `workspaceProxyURL`.
...
///
/// Extracts `x-blazecode-directory` (header or query param), looks up the
