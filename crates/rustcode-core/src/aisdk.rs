...
/// Maps an AI SDK NPM package name to an OpenCode provider ID.
///
...
/// name and the provider context is the OpenCode provider ID.
...
pub struct AisdkProviderMapping {
    ...
    /// The OpenCode provider ID associated with this package.
    ///
