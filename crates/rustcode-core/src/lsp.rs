...
//! lives in the `rustcode-lsp` crate.
//!
//! ## Architecture
//!
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `Position` type (lines 22–25).
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `Range` type (lines 27–31).
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub struct LspRange {
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `Symbol.location` (lines 36–39).
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/diagnostic.ts` severity map (lines 6–10).
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/client.ts` — re-exports
...
impl LspDiagnostic {
    ...
    ///
    /// # Source
    /// Ported from `packages/opencode/src/lsp/diagnostic.ts` `pretty()` (lines 5–18).
    ...
    ///
    /// # Source
    /// Ported from `packages/opencode/src/lsp/diagnostic.ts` `report()` (lines 20–27).
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `SymbolKind` enum (lines 60–87).
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[repr(u32)]
pub enum SymbolKind {
    File = 1,
...
impl SymbolKind {
    ...
    ///
    /// # Source
    /// Ported from `packages/opencode/src/lsp/lsp.ts` `kinds` array (lines 89–98).
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `Symbol` type (lines 33–41).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `DocumentSymbol` type (lines 43–50).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/server.ts` `Info` interface (lines 80–86).
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `Status` type (lines 52–57).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `Status.status` literals (line 56).
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "lowercase")]
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/client.ts` `Info` type (line 25)
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `Event.Updated` (lines 18–20).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/language.ts` `LANGUAGE_EXTENSIONS`
/// const (lines 1–121).
///
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/client.ts` `InitializeError` (lines 29–32).
#[derive(Debug, Error)]
...
///
/// # Source
/// Ported from `packages/opencode/src/lsp/lsp.ts` `LocInput` type (line 112).
#[derive(Debug, Clone, Serialize, Deserialize)]
