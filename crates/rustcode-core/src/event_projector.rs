...
//! - `packages/opencode/src/sync/index.ts` (lines 75–171)
//! - `packages/opencode/src/session/projectors.ts` (lines 1–85)
...
///
/// # Source
/// Ported from `packages/opencode/src/session/projectors.ts` — each
...
///
/// # Source
/// Ported from `packages/opencode/src/sync/index.ts` — the `process` function
/// and `replay` path.
...
impl EventProjector {
    ...
    ///
    /// # Source
    /// Ported from `packages/opencode/src/sync/index.ts` — `SyncEvent.init`'s
    ...
    ///
    /// # Source
    /// Ported from `packages/opencode/src/sync/index.ts` — the `process`
    ...
    ///
    /// # Source
    /// Ported from `packages/opencode/src/sync/index.ts` — the `replay` path
    ...
    ///
    /// # Source
    /// Ported from `packages/opencode/src/sync/index.ts` — the `replayAll`
...
///
/// # Source
/// Ported from `packages/opencode/src/sync/index.ts` — the `run` function
