...
/// Opencode — background: #0d1117, accent: #58a6ff
pub const THEME_OPENCODE: Theme = Theme::derive(
    "opencode", ThemeMode::Dark,
    rgb(0x0d, 0x11, 0x17),
    rgb(0xc9, 0xd1, 0xd9),
    rgb(0x58, 0xa6, 0xff),
    rgb(0x48, 0x4f, 0x58),
    ...
    rgb(0xf8, 0x51, 0x51),
    rgb(0x58, 0xa6, 0xff),
).with_background_panel(rgb(0x16, 0x1b, 0x22))
 .with_background_element(rgb(0x21, 0x26, 0x2d))
 .with_syntax(
    rgb(0x48, 0x4f, 0x58),
    rgb(0xbc, 0x8c, 0xff),
    rgb(0x58, 0xa6, 0xff),
...
/// Load custom themes from `~/.config/opencode/themes/*.json`.
///
